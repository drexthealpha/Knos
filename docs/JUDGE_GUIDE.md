...
| | measured |
|---|---|
| the compare-and-swap that refuses a claim | 0.35 ms |
| one MCP tool call, which opens the store and closes it | 4.9 ms |
| a cold `knos` command, the slowest path here | 15 ms |
| one real source file of this repo, read and parsed | 3.1 ms |
<!-- /measured -->
